...
const mvLinksByTitle = new Map(
  [
    ...
    ["語るなら未来を…", "AFg1x-xCxa4"],
    ["渋谷からPARCOが消えた日", "GsKnmSQRzrE"],
    ["二人セゾン", "mNpPQXMgtmw"],
    ["大人は信じてくれない", "8JZqeFGDszw"],
    ["不協和音", "gfzuzDrVRVM"],
    ["エキセントリック", "65v7JSBpQ4U"],
    ["月曜日の朝、スカートを切られた", "j89r0SNk9hs"],
    ["風に吹かれても", "jsJh1B2jpIs"],
    ["避雷針", "8y14n7mEVlo"],
    ["ガラスを割れ！", "A2k6ZO6B0A8"],
    ["もう森へ帰ろうか？", "f7wTsLBIeC8"],
    ["アンビバレント", "YIt3XpvYc6Q"],
    ["Student Dance", "XRCqKbVs--o"],
    ["黒い羊", "D2QEluvPRiE"],
    ["角を曲がる", "J3_IdDAr-dk"],
    ["渋谷川", "u6skIxzefss"],
    ["チューニング", "9oj37v0j1Zk"],
    ["ゼンマイ仕掛けの夢", "FKfNKxCQfGc"],
